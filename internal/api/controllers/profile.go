...
func NewProfileController(scanService services.ScanServiceInterface, profileRepo repositories.ProfileRepositoryInterface, movieRepo repositories.MovieRepositoryInterface, seriesRepo repositories.SeriesRepositoryInterface) *ProfileController {
