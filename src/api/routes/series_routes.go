...
func HandleSeries(seriesRepo interfaces.SeriesRepositoryInterface, seasonRepo interfaces.SeasonRepositoryInterface, episodeRepo interfaces.EpisodeRepositoryInterface, scanService interfaces.ScanServiceInterface) http.HandlerFunc {
